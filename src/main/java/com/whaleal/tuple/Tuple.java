...
public abstract class Tuple implements Iterable<Object>, Serializable {
    ...
    public final Tuple subTuple(final int start, final int end) {
        ...
        switch (length) {
            ...
            case 6:
                return Tuple6.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(start + 2),this.valueList.get(start + 3), this.valueList.get(start + 4),this.valueList.get(end));
            case 7:
                return Tuple7.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(start + 2),this.valueList.get(start + 3), this.valueList.get(start + 4),this.valueList.get(start + 5),this.valueList.get(end));
            case 8:
                return Tuple8.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(start + 2),this.valueList.get(start + 3), this.valueList.get(start + 4),this.valueList.get(start + 5),this.valueList.get(start + 6),this.valueList.get(end));
            case 9:
                return Tuple9.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(start + 2),this.valueList.get(start + 3), this.valueList.get(start + 4),this.valueList.get(start + 5),this.valueList.get(start + 6),this.valueList.get(start + 7),this.valueList.get(end));
            default:
    ...
    /**
     * 映射元祖
     * 映射后元组大小可以变化 也可以不变 ，由fuction来管理
     *
     * @param mapFunction
     * @return
     */
    public abstract Tuple map( Function<Tuple, Tuple>  mapFunction );
