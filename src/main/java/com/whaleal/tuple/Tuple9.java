...
/**
 * A tuple that holds nine values
 ...
 * @param <T9> The type of the ninth value held by this tuple
 *
 * @author wh
 *
 */
public final class Tuple9< T1, T2, T3, T4, T5, T6, T7, T8, T9 > extends Tuple {
     ...
     * @param <T9>  第九个元素类型
     * @return 元组
     * @see TupleUtil#tuple(Object, Object, Object, Object, Object,Object,Object,Object,Object)
     */
    ...
    public Tuple9<T9,T8,T7,T6,T5,T4,T3,T2,T1> reverse() {
        return new Tuple9<>(this.t9, this.t8, this.t7, this.t6, this.t5, this.t4, this.t3, this.t2, this.t1);
    }
    /**
     * 元组映射 由function 保证
     * @param mapFunction
